...
* Support for Live Reload via Hotswap Agent.  [Current integration details](https://github.com/grails/grails-forge/issues/445).  This was made possible by the removal of the default Micronaut integration. 
