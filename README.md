...
This is the project to build the Grails website.and it is a static website which is built with [Gradle](https://gradle.org).It uses a Gradle Plugin which can be found at `buildSrc`.
