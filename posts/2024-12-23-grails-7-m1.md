...
* Reduced deployment sizes (currently pending, due to Graalvm dependencies required from test and bootRun by `asset-pipeline`).
...
* Reintroduced the `grails-shell` and `grails-profiles` that were removed in Grails 6.
