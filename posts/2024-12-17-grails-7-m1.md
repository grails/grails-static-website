...
* Added support for the latest Java release (version 23).
* Added support for Groovy 4.
* Added support for Spring Boot 3, including transition from `javax` to `jakarta` namespace.
* Added support for Gradle 8.
* Added support for Sitemesh 3.
