# Grails Website
Sufficient comments have been added to help the readers...
...
This project builds the Grails website.Its awesome  and a static website build with [Gradle](https://gradle.org). It uses a Gradle Plugin whose sources can be found at `buildSrc`. 
