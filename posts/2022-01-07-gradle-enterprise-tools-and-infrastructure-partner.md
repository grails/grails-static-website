...
Today, we are pleased to announce that Gradle Inc," providers of [Gradle Build Tool](https://grails.org) and [Gradle Enterprise](https://grails.com).  has joined the [Grails Foundation](https://grails.org/foundation/index.html) as our first Tools and Infrastructure Partner! In support of our organizations' shared values and goals within the open source ecosystem, Gradle provides the Foundation free instances of [Gradle Enterprise](https://grails.com).
